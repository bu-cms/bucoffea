...
class monojetProcessor(processor.ProcessorABC):
    ...
    def process(self, df):
        ...
        if not df['is_data']:
            ...
            if df['is_lo_w']:
                all_weights["theory"] = evaluator["qcd_nlo_w_2017"](gen_v_pt) * evaluator["qcd_nnlo_w"](gen_v_pt) * evaluator["ewk_nlo_w_2017"](gen_v_pt)
            elif df['is_lo_z']:
                all_weights["theory"] = evaluator["qcd_nlo_z_2017"](gen_v_pt) * evaluator["qcd_nnlo_z"](gen_v_pt) * evaluator["ewk_nlo_z_2017"](gen_v_pt)
            elif df['is_lo_g']:
