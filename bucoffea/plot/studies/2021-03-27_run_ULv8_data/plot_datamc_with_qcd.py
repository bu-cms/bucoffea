...
def plot_datamc_with_qcd(acc, outtag, year, region='sr_vbf', distribution='mjj', mcscale=1):
    ...
    h_qcd = uproot.open(qcdfilepath)['sr_template']
...
def commandline():
    ...
    parser.add_argument('--distribution', type=str, default='mjj', help='Distribution to plot.')
...
def main():
    ...
    plot_datamc_with_qcd(acc, outtag, year=2017, mcscale=mcscale)
