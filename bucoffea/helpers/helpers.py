...
def min_dphi_jet_met(jets, met_phi, njet=4, ptmin=30, etamax=2.4, var=''):
    ...
    :param var: JES/JER variation, by default no variation is used.
    ...
    jet_pt = getattr(jets, f'pt{var}')
    jets=jets[(jet_pt>ptmin)&(jets.abseta < etamax)]
    jets = jets[:,:njet]
